"""
Experiment 2: ViT-Tiny on STL-10 — direct baseline comparison.
"""
...
CONFIG = {
    ...
    "checkpoint_dir": "./checkpoints_vit_stl10",
    "log_file": "./checkpoints_vit_stl10/metrics_vit_stl10.csv",
}


def main(args):
    print_experiment_header("ViT-Tiny on STL-10 (Baseline)", CONFIG)

    device = setup_gpu()

    model = build_vit_tiny_stl10(num_classes=CONFIG["num_classes"])
